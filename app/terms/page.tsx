            ...
            <div className="space-y-6">
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  By accessing and using AssetTracker Pro, you accept and agree to be bound by the
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  Permission is granted to temporarily use AssetTracker Pro for personal and
                  commercial asset management purposes. This is the grant of a license, not a
                  transfer of title.
                </p>
              </section>
