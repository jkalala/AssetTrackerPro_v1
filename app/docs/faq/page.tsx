      ...
      <div className="max-w-5xl mx-auto">
            ...
            {!selectedCategory && !searchQuery && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Select a category from the sidebar or use the search bar to find answers to your questions
                  </CardDescription>
                </CardHeader>
                <CardContent>
                    ...
                    {faqCategories.slice(0, 4).map((category) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <p className="text-sm text-gray-600 mb-2">{category.questions.length} articles</p>
        ...
        <Card className="mt-8">
          <CardHeader>
            ...
            <CardDescription>Our support team is here to help you succeed with your asset management</CardDescription>
          </CardHeader>
          <CardContent>
