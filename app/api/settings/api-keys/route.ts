...
export async function GET() {
  ...
  const { data, error } = await supabase.from('api_keys').select('id, name, created_at, revoked, user_id').eq('tenant_id', profile.tenant_id).order('created_at', { ascending: false });
