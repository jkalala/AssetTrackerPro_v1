  ...
  return (
    <div className="container mx-auto py-8 max-w-4xl">
      ...
      <p className="text-gray-600 mb-8 text-center">
        Follow these steps to configure email confirmations and GitHub OAuth in your Supabase project
      </p>
        ...
        <TabsContent value="overview">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Complete these steps to configure authentication for your application</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="rounded-lg border p-4 bg-amber-50 border-amber-200">
                ...
                <p className="text-amber-700">
                  Auth settings in Supabase can only be configured through the dashboard UI, not through SQL queries.
                  The SQL script provided creates a reference table but doesn't directly modify auth settings.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3 p-3 rounded-lg border border-gray-200 bg-white">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Execute the <code>scripts/11-configure-auth-settings-fixed.sql</code> script to create a reference
                      table
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 rounded-lg border border-gray-200 bg-white">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Set up email confirmations in the Supabase dashboard</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 rounded-lg border border-gray-200 bg-white">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Set up GitHub authentication with the provided credentials</p>
                  </div>
                </div>
            ...
            <CardFooter>
              <Button asChild className="w-full">
                <a href="https://app.supabase.com/project/_/auth/providers" target="_blank" rel="noopener noreferrer">
        ...
        <TabsContent value="email">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure email confirmations in your Supabase project</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div className="rounded-lg border p-4">
                  <h3 className="text-lg font-medium mb-2">Step 1: Configure Site URL</h3>
                  <p className="text-sm text-gray-500 mb-4">Set your site URL in the Supabase dashboard</p>

                  <div className="space-y-2">
                    <Label htmlFor="site-url">Site URL</Label>
                    <div className="flex gap-2">
                      <Input id="site-url" value={SITE_URL} readOnly className="flex-1" />
                      <Button variant="outline" size="icon" onClick={() => copyToClipboard(SITE_URL, "site-url")}>
                        {copied["site-url"] ? <CheckCircle className="h-4 w-4" /> : <Copy className="h-4 w-4" />}
                      </Button>
                    </div>
                    <p className="text-xs text-gray-500">Navigate to: Authentication → URL Configuration → Site URL</p>
                  </div>
                </div>

                <div className="rounded-lg border p-4">
                  <h3 className="text-lg font-medium mb-2">Step 2: Configure Redirect URLs</h3>
                  <p className="text-sm text-gray-500 mb-4">Add these redirect URLs to your Supabase project</p>

                  <div className="space-y-4">
                    <div className="space-y-2">
                      <Label>Production Redirect URLs</Label>
                      <div className="space-y-2">
                        {[`${SITE_URL}/auth/callback`, `${SITE_URL}/dashboard`, `${SITE_URL}/`].map((url, i) => (
                          <div key={i} className="flex gap-2">
                            <Input value={url} readOnly className="flex-1" />
                            <Button variant="outline" size="icon" onClick={() => copyToClipboard(url, `prod-url-${i}`)}>
                              {copied[`prod-url-${i}`] ? (
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="space-y-2">
                        {[`${LOCAL_URL}/auth/callback`, `${LOCAL_URL}/dashboard`, `${LOCAL_URL}/`].map((url, i) => (
                          <div key={i} className="flex gap-2">
                            <Input value={url} readOnly className="flex-1" />
                            <Button
                              variant="outline"
                ...
                <div className="rounded-lg border p-4">
                  ...
                  <p className="text-sm text-gray-500 mb-4">Enable and configure the Email provider</p>
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-xs text-gray-500">Navigate to: Authentication → Providers → Email</p>
                  </div>
                </div>
              </div>
            </CardContent>
        ...
        <TabsContent value="github">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure GitHub authentication with your credentials</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div className="rounded-lg border p-4">
                  <h3 className="text-lg font-medium mb-2">Step 1: Enable GitHub Provider</h3>
                  <p className="text-sm text-gray-500 mb-4">Enable the GitHub provider in your Supabase project</p>
                ...
                <div className="rounded-lg border p-4">
                  ...
                  <p className="text-sm text-gray-500 mb-4">Add your GitHub OAuth credentials to Supabase</p>

                  <div className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="github-client-id">Client ID</Label>
                      <div className="flex gap-2">
                        <Input id="github-client-id" value={GITHUB_CLIENT_ID} readOnly className="flex-1" />
                        <Button
                          variant="outline"
                          size="icon"
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        <Input id="github-client-secret" value={GITHUB_CLIENT_SECRET} readOnly className="flex-1" />
                        <Button
                          variant="outline"
                          size="icon"
                          onClick={() => copyToClipboard(GITHUB_CLIENT_SECRET, "github-client-secret")}
                        >
        ...
        <TabsContent value="test">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Verify that your authentication configuration is working correctly</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div className="rounded-lg border p-4">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3 p-3 rounded-lg border border-gray-200 bg-white">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Create a new account using an email address</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-3 rounded-lg border border-gray-200 bg-white">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Verify that you receive a confirmation email</p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3 p-3 rounded-lg border border-gray-200 bg-white">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Attempt to sign in with your GitHub account</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-3 rounded-lg border border-gray-200 bg-white">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Grant permission to your GitHub account</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-3 rounded-lg border border-gray-200 bg-white">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Confirm you are redirected to the dashboard</p>
                      </div>
                    </div>
                  </div>
                </div>
